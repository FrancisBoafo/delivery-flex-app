...
export default function Example() {
  ...
  return (
    ...
    <div className="bg-white" >
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1619096118293-a34a2f9b7339?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2050&q=80")',
