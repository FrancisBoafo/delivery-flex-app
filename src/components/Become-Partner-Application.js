...
export default function Example() {
  ...
  <div className="absolute inset-y-0 left-0 flex items-center">
    ...
    <select
      id="country"
      name="country"
      className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm relative"
    >
      <option>US</option>
      <option>CA</option>
      <option>EU</option>
      <ChevronDownIcon
        className="pointer-events-none absolute right-0 top-0 h-full w-5 text-gray-900"
        aria-hidden="true"
      />
    </select>
